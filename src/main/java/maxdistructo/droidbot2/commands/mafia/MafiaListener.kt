...
class MafiaListener {
    ...
    fun onMessageReceivedEvent(event: MessageReceivedEvent) {
        ...
        if (message.guild.longID == 249615705517981706L || message.guild.longID == 268370862661435392L && Perms.checkMafiaChannels(message) && messageContent.isNotEmpty() && messageContent[0] == prefix + "mafia") {
 ...
 /*                           "akill" -> {
                            ...
                            "vampkill" ->{
                                Mafia.killPlayer(message, Utils.getMentionedUser(message)!!.longID)
                                Message.sendMessage(game.dayChannel, "__**" + Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was bit by Vampire**__" + "\n" + Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was a " + MafiaConfig.getPlayerDetails(message, Utils.getMentionedUser(message)!!.longID)[2])
                                Message.sendMessage(game.adminChannel, Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was killed by a Vampire. Authorizign Member: " + message.author.getDisplayName(message.guild))
                            }
                            "vhkill" ->{
                                Mafia.killPlayer(message, Utils.getMentionedUser(message)!!.longID)
                                Message.sendMessage(game.dayChannel, "__**" + Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was staked by a Vampire Hunter**__" + "\n" + Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was a " + MafiaConfig.getPlayerDetails(message, Utils.getMentionedUser(message)!!.longID)[2])
                                Message.sendMessage(game.adminChannel, Utils.getMentionedUser(message)!!.getDisplayName(message.guild) + " was staked by a Vampire Hunter. Authorizign Member: " + message.author.getDisplayName(message.guild))
*                           }*/
                            "shuffle" -> {
                    ...
                    } else { //This is all this listener will handle so putting this requirement for the rest of the code to execute.
                        ...
                        when (messageContent[1]) {
                            ...
                            "vote", game.day, Utils.getMentionedUser(message)!! != message.author ->{
