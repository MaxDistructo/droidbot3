...
object Check {
    ...
    fun onCheckCommand(args: Array<String>, message: IMessage): String {
        return " Is Mod: " + Perms.checkMod(message) + "\n Is Admin: " + Perms.checkAdmin(message) + "\n Is Owner: " + Perms.checkOwner(message) + "\n Is Games Channel: " + Perms.checkGames(message) + "\n Mafia: \n Is Admin: " + maxdistructo.droidbot2.commands.mafia.Perms.checkAdmin(message) + "\n Is Mod: " + maxdistructo.droidbot2.commands.mafia.Perms.checkMod(message) + "\n  Is Mafia Channel: " + maxdistructo.droidbot2.commands.mafia.Perms.checkMafiaChannels(message)
    }
}
